...
public class ApproveSavingsAccountCommandStrategy implements CommandStrategy {
    ...
    public BatchResponse execute(BatchRequest request, @SuppressWarnings("unused") UriInfo uriInfo) {
        ...
        // URL: savingsaccounts/{id}?command=approve
        ...
        String responseBody = savingsAccountsApiResource.update(savingsAccountId, request.getBody(), "approve");
